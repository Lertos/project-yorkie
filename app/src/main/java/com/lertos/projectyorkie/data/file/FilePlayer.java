...
public class FilePlayer extends DataFile {
    ...
    private ArrayList<Triple> defaultKeys = new ArrayList<>(Arrays.asList(
            ...
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_HOME, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_ACTIVITY, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_PETTING, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_TOURNAMENT, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_CATCH_DOG_TREATS, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_DODGE_THE_CATS, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_TREAT_TOSS, boolean.class, "true"),
            new Triple(FilePlayerKeys.DATA_SHOW_TUT_WHACK_THE_CAT, boolean.class, "true"),
            ...
            new Triple(FilePlayerKeys.DATA_CURRENT_HEARTS, double.class, "100"),
            new Triple(FilePlayerKeys.DATA_CURRENT_HEART_TOKENS, double.class, "10"),
