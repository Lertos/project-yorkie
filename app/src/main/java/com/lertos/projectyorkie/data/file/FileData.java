...
public class FileData extends DataFile {
    ...
    private ArrayList<Triple> defaultKeys = new ArrayList<>(Arrays.asList(
            new Triple(FileDataKeys.DATA_HAS_PLAYED_BEFORE, boolean.class, "0"),
            new Triple(FileDataKeys.DATA_LAST_TIME_ON, String.class, ""),
            new Triple(FileDataKeys.DATA_SHOW_TUT_HOME, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_ACTIVITY, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_PETTING, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_TOURNAMENT, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_CATCH_DOG_TREATS, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_DODGE_THE_CATS, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_TREAT_TOSS, boolean.class, "1"),
            new Triple(FileDataKeys.DATA_SHOW_TUT_WHACK_THE_CAT, boolean.class, "1"),
